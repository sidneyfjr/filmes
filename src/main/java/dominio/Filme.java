...
public class Filme implements Serializable {
	...
	// Esse método recebe uma classe Participação como parâmetro
	public void addParticipacao(Participacao x){
		// Adiciona uma participacão na lista de participações da classe Filme
		this.participacoes.add(x);
		// Seta esse filme na classe Participacao
		x.setFilme(this);
	}
