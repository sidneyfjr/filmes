...
public class Participacao implements Serializable {
	...
	public Participacao(Integer codParticipacao, String personagem, BigDecimal desconto, Filme filme, Artista artista) {
		...
		// Temos um filme e um artista que apontam para uma participação
		// mas não temos uma participação apontando para um filme nem para um artista.
		// filme.addParticipacao(this.filme);
		// artista.addParticipacao(this.artista);
	}
